...
const checks = [
  ...
  ['relative crosshair dependency', html.includes('vendor/galka-relative-crosshair.js?v=2') && relativeCrosshair.includes('installRelativeCrosshair')],
  ...
  ['stable crosshair on finger release', relativeCrosshair.includes('pinnedAtRelease') && relativeCrosshair.includes('chart.crosshair = pinnedAtRelease') && relativeCrosshair.includes('chart.draw()')],
