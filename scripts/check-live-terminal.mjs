...
const checks = [
  ...
  ['single tested touch controller', !html.includes('galka-relative-crosshair.js') && html.includes('vendor/galka-touch-actions.js?v=4') && touchActions.includes('installTouchActions')],
