...
const checks = [
  ...
  ['relative crosshair dependency', html.includes('vendor/galka-relative-crosshair.js?v=3') && relativeCrosshair.includes('installRelativeCrosshair')],
  ...
  ['relative pinned crosshair movement', relativeCrosshair.includes('crosshairStartX') && relativeCrosshair.includes('touchStartX') && relativeCrosshair.includes('point.x - relativeGesture.touchStartX') && relativeCrosshair.includes('queueMicrotask')],
  ['release snap is suppressed', relativeCrosshair.includes('suppressReleaseSnap') && relativeCrosshair.includes("if (suppressReleaseSnap && point?.zone === 'plot') return") && relativeCrosshair.includes('pinnedAtRelease')],
